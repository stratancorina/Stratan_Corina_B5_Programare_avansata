...
public class Streets {
    ...
    public Streets(String name, int length, Intersection i1, Intersection i2) {
        this.name = name;
        this.length = length;
        this.i1 = i1;
        this.i2 = i2;
    ...
    public static int sortedStreets(Object o1, Object o2) {
        if(!(o1 instanceof Streets) || !(o2 instanceof Streets) )
            throw new ClassCastException ("Uncomparable");

        Streets s1 = (Streets) o1;
        Streets s2 = (Streets) o2;
